...
rs1.Open "select * from Appl_A where Tanggal = '" & Text1 & "'", kon
If Not rs1.EOF Then
    Text2 = rs1!NoMesin
         With DataGrid1
   Set .DataSource = rs1
...
Dim hps As String
hps = "delete from Appl_A where Tanggal = '" & Text1 & "' and Jam = '" & Text3 & "'"
kon.Execute hps
...
rs1.Open "select*from Appl_A", kon, adOpenDynamic, adLockOptimistic
