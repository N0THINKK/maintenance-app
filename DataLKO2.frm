...
'rs2.Open "select * from Product where Sequen = '" & Text1 & "'", con
'If Not rs2.EOF Then
 '   Text2 = rs2!Kombinasi
Form_Activate
...
Dim hps As String
hps = "delete from LKO where Tanggal = '" & Text1 & "' and UrutanKanban = '" & Text5 & "' and Waktu = '" & Text6 & "'"
kon.Execute hps
...
con.Open "provider=Microsoft.jet.oledb.4.0;data source=" & App.Path & "\Produk.mdb"
