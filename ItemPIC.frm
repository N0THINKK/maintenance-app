...
Dim SQLTambah As String
SQLTambah = "insert into NIKOP (OPERATOR) values ('" & Text2 & "')"
...
Set rs2 = New ADODB.Recordset
rs2.Open "select*from NIKOP", kon, adOpenDynamic, adLockOptimistic
...
Dim SQLTambah As String
SQLTambah = "insert into PICREPAIR (TEKNISI) values ('" & Text3 & "')"
...
Set rs3 = New ADODB.Recordset
rs3.Open "select*from PICREPAIR", kon, adOpenDynamic, adLockOptimistic
