...
Begin VB.Form PhAplB 
   ...
   Begin VB.Image Image1 
      Height          =   7620
      Left            =   120
      Picture         =   "PhAppl sisi B.frx":0000
      Top             =   1320
      Width           =   3675
   End
...
Unload Me
  ...
  Call MessageBox(hwnd, "DAplikator Sisi A ditampilkan", _
...
Form_Activate
rs2.Open "select * from Appl where NoMesin = '" & Combo3 & "' and Sisi = '" & Label13 & "'", kon
If Not rs2.EOF Then
List1.Clear
