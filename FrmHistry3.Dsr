VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} FrmHistry3 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "History Problem Mesin 3"
   ClientHeight    =   6780
   ClientLeft      =   30
   ClientTop       =   375
   ClientWidth     =   10560
   ControlBox      =   0   'False
   Icon            =   "FrmHistry3.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   OleObjectBlob   =   "FrmHistry3.dsx":1084A
   StartUpPosition =   2  'CenterScreen
End
Attribute VB_Name = "FrmHistry3"
