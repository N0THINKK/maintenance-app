...
Begin VB.Form DataDefect 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Record Defect PreAssy"
   ClientHeight    =   6870
   ClientLeft      =   210
   ClientTop       =   555
   ClientWidth     =   9870
   ControlBox      =   0   'False
   Icon            =   "DataDefect.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   693.94
...
Dim hps As String
hps = "delete from Mikro where Tanggal = '" & Text1 & "'"
kon.Execute hps
...
kon.Open App.Path & "\RecordDefect.mdb"
Set rs1 = New ADODB.Recordset
rs1.Open "select*from Defect", kon, adOpenDynamic, adLockOptimistic
