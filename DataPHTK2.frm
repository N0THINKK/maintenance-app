...
Begin VB.Form DataPHTK 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Record Patroli Harian Teknisi"
   ClientHeight    =   6870
   ClientLeft      =   210
   ClientTop       =   555
   ClientWidth     =   9870
   ControlBox      =   0   'False
   Icon            =   "DataPHTK2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   693.94
...
rs1.Open "select * from tb1 where TANGGAL = '" & Text1 & "'", kon
If Not rs1.EOF Then
    Text2 = rs1!NoMesin
         With DataGrid1
   Set .DataSource = rs1
...
rs1.Open "select*from tb1", kon, adOpenDynamic, adLockOptimistic
