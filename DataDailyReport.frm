...
Begin VB.Form DataDailyReport 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Record Daily Report"
   ClientHeight    =   6870
   ClientLeft      =   210
   ClientTop       =   555
   ClientWidth     =   9870
   ControlBox      =   0   'False
   Icon            =   "DataDailyReport.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   693.94
   ...
   End
End
Attribute VB_Name = "DataDailyReport"
...
Dim hps As String
hps = "delete from Dy where Tanggal = '" & Text1 & "' and Waktu = '" & Text5 & "'"
kon.Execute hps
...
rs1.Open "select*from Dy", kon, adOpenDynamic, adLockOptimistic
If Text4 = DataGrid1.Columns(0) And Text3 = DataGrid1.Columns(1) Then
DataGrid1.Columns(27) = Combo1.Text
...
Text3 = DataGrid1.Columns(1)
Text4 = DataGrid1.Columns(0)
...
kon.Open App.Path & "\DataDailyReportCutting.mdb"
Set rs1 = New ADODB.Recordset
rs1.Open "select*from Dy", kon, adOpenDynamic, adLockOptimistic
Set DataGrid1.DataSource = rs1
rs1.Sort = DataGrid1.Columns(15).DataField & " DESC"
