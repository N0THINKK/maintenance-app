VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} FrmPHOPB 
   ...
   ClientWidth     =   12015
   ControlBox      =   0   'False
   Icon            =   "FrmPHOPB.dsx":0000
   MaxButton       =   0   'False
   MinButton       =   0   'False
   OleObjectBlob   =   "FrmPHOPB.dsx":1084A
   StartUpPosition =   2  'CenterScreen
End
Attribute VB_Name = "FrmPHOPB"
...
Exit Sub
End If
If OptionButton39.Value = False And OptionButton40.Value = False And OptionButton43.Value = False Then
